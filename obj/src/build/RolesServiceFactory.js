...
class RolesServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
RolesServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "factory", "default", "default", "1.0");
RolesServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "persistence", "memory", "*", "1.0");
RolesServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "persistence", "file", "*", "1.0");
RolesServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "persistence", "mongodb", "*", "1.0");
RolesServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "controller", "default", "*", "1.0");
RolesServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "service", "seneca", "*", "1.0");
RolesServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-roles", "service", "http", "*", "1.0");
