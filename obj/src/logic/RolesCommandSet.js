...
class RolesCommandSet extends pip_services_commons_node_1.CommandSet {
    ...
    makeGetRolesCommand() {
        return new pip_services_commons_node_2.Command("get_roles", null, (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            this._logic.getRoles(correlationId, userId, callback);
        });
    }
    makeSetRolesCommand() {
        return new pip_services_commons_node_2.Command("set_roles", null, (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
    ...
    makeGrantRolesCommand() {
        return new pip_services_commons_node_2.Command("grant_roles", null, (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            let roles = args.getAsArray("roles");
    ...
    makeRevokeRolesCommand() {
        return new pip_services_commons_node_2.Command("revoke_roles", null, (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            let roles = args.getAsArray("roles");
    ...
    makeAuthorizeCommand() {
        return new pip_services_commons_node_2.Command("authorize", null, (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            let roles = args.getAsArray("roles");
