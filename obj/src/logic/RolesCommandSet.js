...
class RolesCommandSet extends pip_services_commons_node_1.CommandSet {
    ...
    makeGetRolesByFilterCommand() {
        return new pip_services_commons_node_2.Command("get_roles_by_filter", new pip_services_commons_node_5.ObjectSchema(true)
    ...
    makeGetRolesByIdCommand() {
        return new pip_services_commons_node_2.Command("get_roles_by_id", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('user_id', pip_services_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            this._logic.getRolesById(correlationId, userId, callback);
        });
    }
    makeSetRolesCommand() {
        return new pip_services_commons_node_2.Command("set_roles", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('user_id', pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty('roles', new pip_services_commons_node_6.ArraySchema(pip_services_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
    ...
    makeGrantRolesCommand() {
        return new pip_services_commons_node_2.Command("grant_roles", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('user_id', pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty('roles', new pip_services_commons_node_6.ArraySchema(pip_services_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            let roles = args.getAsArray("roles");
    ...
    makeRevokeRolesCommand() {
        return new pip_services_commons_node_2.Command("revoke_roles", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('user_id', pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty('roles', new pip_services_commons_node_6.ArraySchema(pip_services_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            let roles = args.getAsArray("roles");
    ...
    makeAuthorizeCommand() {
        return new pip_services_commons_node_2.Command("authorize", new pip_services_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('user_id', pip_services_commons_node_7.TypeCode.String)
            .withRequiredProperty('roles', new pip_services_commons_node_6.ArraySchema(pip_services_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
            let userId = args.getAsNullableString("user_id");
            let roles = args.getAsArray("roles");
